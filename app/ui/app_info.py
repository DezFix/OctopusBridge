# -*- coding: utf-8 -*-
"""Диалог «О программе»: описание, теги движков, поддержка.

Теги движков подтягиваются из реестра app.engines.registry.MODULES —
новый движок появится сам.
"""
...
class AboutDialog(QDialog):
    """«О программе» — описание, теги движков, поддержка."""
