...
> **⚠ В разработке.** OctopusBridge активно дорабатывается. Возможны баги, падения и повреждённые переводы, особенно для движка **Twine**. Перед переводом всегда делайте резервную копию игры и сообщайте о найденных проблемах.
